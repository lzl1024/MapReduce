...
public class Message implements Serializable {
    ...
    public static enum MSG_TYPE {
        FILE_SPLIT_REQ, FILE_SPLIT_ACK, SLAVE_QUIT, KEEP_ALIVE, NODE_FAIL, MAPPER_COMPLETE, NODE_FAIL_ACK, WORK_COMPELETE, WORK_FAIL, NEW_JOB, MAPPER_REQ, REDUCER_REQ, REDUCER_COMPLETE, FILE_DOWNLOAD, NOTIFY_PORT, CHANGE_REDUCELIST, FILE_REQ, GET_FILE
    }
